...
let ratings = watchList.map(movieRating);

function movieRating(obj) {
...
// First solution.  Needs work.
//Only change code below this line

function getGoodMovies(obj) {
  return Number(obj.imdbRating) >= 8.0;
}

function getMovieAndRating(obj) {
    return ({"title": obj["Title"], "rating": obj["imdbRating"]});
}

var goodMoviesList = watchList.filter(getGoodMovies);
var filteredList = goodMoviesList.map(getMovieAndRating);

// Only change code above this line

console.log(filteredList);

// Second solution after study
//Only change code below this line
